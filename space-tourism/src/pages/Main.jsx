  ...
  return (
    <main className="flex flex-col md:flex-col lg:flex-row text-center md:text-left gap-4 min-h-screen lg:p-8 md:p-0 w-4/5 m-auto md:items-center lg:items-stretch">
      <div className="flex flex-col justify-center flex-1">
        <h2 className="font-barlow-condensed text-[16px] lg:text-[28px] md:text-[20px] lg:text-left md:text-center tracking-[4.75px] text-grayy">
          SO, YOU WANT TO TRAVEL TO
        </h2>
        <h1 className="font-bellefair text-[80px] md:text-[150px]">SPACE</h1>
        <p className=" text-grayy lg:text-[18px] lg:text-left md:text-center text-center max-w-440px font-barlow">
